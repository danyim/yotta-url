...
The one-way hashing function exhibits an [avalanche effect](https://en.wikipedia.org/wiki/Avalanche_effect), such that appending something as minor as a trailing slash (`http://google.com/`) will result in a vastly different key than the previous:
